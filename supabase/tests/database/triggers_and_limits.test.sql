...
insert into public.clients (id, owner_id, name, updated_at)
values ('aaaaaaaa-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111',
        'Cliente Teste', '2001-01-01'::timestamptz);

insert into public.notes (id, client_id, title, updated_at)
values ('cccccccc-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000001',
        'Nota Teste', '2001-01-01'::timestamptz);
...
select ok(
  ...
  'profiles tem o trigger de updated_at ligado');

select ok(
  exists (select 1 from pg_trigger
           where tgrelid = 'public.clients'::regclass
             and tgname = 'clients_set_updated_at' and not tgisinternal),
  'clients tem o trigger de updated_at ligado');

select ok(
  exists (select 1 from pg_trigger
           where tgrelid = 'public.notes'::regclass
             and tgname = 'notes_set_updated_at' and not tgisinternal),
  'notes tem o trigger de updated_at ligado');
...
select ok(
  ...
  'atualizar um perfil move updated_at para o instante corrente');
...
select ok(
  (select updated_at from public.clients where id = 'aaaaaaaa-0000-0000-0000-000000000001')
    > '2020-01-01'::timestamptz,
  'atualizar um cliente move updated_at para o instante corrente');
...
select ok(
  (select updated_at from public.notes where id = 'cccccccc-0000-0000-0000-000000000001')
    > '2020-01-01'::timestamptz,
  'atualizar uma nota move updated_at para o instante corrente');
